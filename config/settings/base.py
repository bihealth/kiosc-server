...
DATA_UPLOAD_MAX_MEMORY_SIZE = 4_000_000_000
...
LOCAL_APPS = [
    ...
    # Local apps
    "dockerapps.apps.DockerappsConfig",
]
...
DOCKER_HOST = env.str("DOCKER_HOST", "127.0.0.1")
...
PROJECTROLES_EMAIL_SENDER_REPLY = env.str("PROJECTROLES_EMAIL_SENDER_REPLY", None)
...
PROJECTROLES_DEFAULT_ADMIN = "root"
